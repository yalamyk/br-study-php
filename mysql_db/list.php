...
$list_result = mysqli_query($link,'SELECT * FROM topic');
$get_id = mysqli_real_escape_string($_GET['id']);

if(!empty($_GET['id'])) {
    $topic_result=mysqli_query($link,'SELECT * FROM topic WHERE id = '.$get_id);
